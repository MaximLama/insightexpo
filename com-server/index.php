...
$APPLICATION->SetPageProperty("description", "Мы предлагаем не только производство выставочных стендов любой сложности, но и различное мультимедийное оборудование, мебель, написание программного обеспечения, профессиональное создание аудиовизуального контента. Застройка стендов для выставки!");
$APPLICATION->SetTitle("Выставочные стенды в Москве купить - производство и изготовление эксклюзивных выставочных стендов под ключ с застройкой");

//БАННЕР
$banner = CIBlockElement::GetList(
	array("SORT"=>"ASC"),
	array("ID"=>17, "ACTIVE"=>"Y"),
	false,
	false,
	array(
		"ID",
...
?>
		...
		<section class="other-stages other-stages-main">
			<div class="container">
				
				<?$APPLICATION->IncludeComponent(
					"bitrix:news.detail",
					"izgotovlenie-stendov",
					Array(
						"ACTIVE_DATE_FORMAT" => "d.m.Y",
						"ADD_ELEMENT_CHAIN" => "N",
						"ADD_SECTIONS_CHAIN" => "N",
